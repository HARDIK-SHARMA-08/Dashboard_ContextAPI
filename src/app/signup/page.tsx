...
export default function Page() {
  ...
  return (
    <div className="h-screen w-full flex flex-row items-center justify-center p-6 bg-neutral-50 dark:bg-neutral-800">

      <div className="w-full bg-white rounded-2xl shadow dark:border md:mt-0 sm:max-w-3xl xl:p-0 dark:bg-neutral-900 dark:border-neutral-700 flex flex-row items-center">
        <div className="hidden md:block h-full bg-indigo-500 py-56 rounded-l-2xl px-10">
