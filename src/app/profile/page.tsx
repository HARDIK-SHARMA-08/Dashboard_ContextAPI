...
import { EditProfile, Modal, Navbar } from "../components";
      ...
      <div className="container mx-auto my-5 p-16">
        <div className="md:flex no-wrap md:-mx-2 ">
          ...
          <div className="w-full md:w-3/12 md:mx-2">
            {/* Profile Card */}
            <div className="bg-white p-6 border-t-4 border-green-400 rounded-2xl h-full">
          ...
          <div className="w-full md:w-9/12 mx-2 h-64">
            {/* About Section */}
            <div className="bg-white p-6 shadow-sm rounded-sm border-t-4 border-green-400 rounded-2xl h-full">
              ...
              <div className="text-gray-700">
                ...
                <button
                  className="bg-green-400 p-6 mt-4 rounded-xl font-bold text-white uppercase"
                  onClick={handleOpen}
                >
                  Edit Profile
                </button>
